...
//
//Mobile.tap(findTestObject('Application/CicleStaging/GC/GCCloseObject'), 0)
//
//Mobile.tap(findTestObject('Application/CicleStaging/GC/GCMention'), 0)
//
//Mobile.verifyElementVisible(findTestObject('Application/CicleStaging/GC/android.widget.TextView - Mention'), 0)
//
//Mobile.tap(findTestObject('Application/CicleStaging/GC/GC202Close'), 0)
//
//Mobile.tap(findTestObject('Application/CicleStaging/GC/GC202TypeAMassage'), 0)
//
//Mobile.delay(7, FailureHandling.STOP_ON_FAILURE)
//
//Mobile.tapAtPosition(357, 1570)
//
//Mobile.delay(7, FailureHandling.STOP_ON_FAILURE)
//
//Mobile.tapAtPosition(81, 1318)
//
//Mobile.delay(7, FailureHandling.STOP_ON_FAILURE)

//WebUI.callTestCase(findTestCase('1GC/GC202'), [:], FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Application/CicleStaging/GC/GC203Clip'), 0)

Mobile.delay(13, FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Application/CicleStaging/GC/GC203android.widget.TextView - Document (1)'), 0)

Mobile.tapAtPosition(271, 1762, FailureHandling.STOP_ON_FAILURE)

Mobile.delay(13, FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Application/CicleStaging/GC/GC203 - 1 Audio'), 0)

Mobile.delay(13, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementVisible(findTestObject('Application/CicleStaging/GC/GC203android.widget.TextView - No matches in Recent'), 
    0)
