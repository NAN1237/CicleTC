...
//WebUI.callTestCase(findTestCase('3BD/BD202'), [:], FailureHandling.STOP_ON_FAILURE)
...
Mobile.tap(findTestObject('Application/CicleStaging/Board/BD104android.widget.TextView - Board'), 0)

Mobile.tap(findTestObject('Application/CicleStaging/Board/BD104android.widget.TextView - Board'), 0)

Mobile.delay(7, FailureHandling.STOP_ON_FAILURE)

Mobile.checkElement(findTestObject('Application/CicleStaging/Board/BD104android.widget.TextView -'), 0)

Mobile.delay(7, FailureHandling.STOP_ON_FAILURE)

Mobile.swipe(733, 1000, 0, 1000)
