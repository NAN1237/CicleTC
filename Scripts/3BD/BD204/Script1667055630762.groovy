...
//WebUI.callTestCase(findTestCase('3BD/BD203'), [:], FailureHandling.STOP_ON_FAILURE)

Mobile.pressBack()

Mobile.delay(0, FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Application/CicleStaging/Board/BD204android.widget.TextView -'), 0)
...
Mobile.tap(findTestObject('Application/CicleStaging/Board/BD204android.widget.TextView - ATTACH FILE'), 0)
